...
export default class DemandForEssentialServices  extends React.Component {
  ...
  render () {
    return (
      ...
      <div>
        ...
        <p  onClick={this.handleOpenModal}  className="text-uppercase fcwhite">Demand for Essential Services</p>
        <Modal
            ...
            <div class="columns">
                <div class="column ">
                  <div className="box m-5">
                    <h5 className="title m-b-0 m-l-10 is-6 fcprimary-dark text-caps text-center">Percentage Bed Occupancy for the period:  {this.state.period}</h5>
                    <br/>
                    <IndicatorLineGraph id={33682} pe={this.state.period} ouid={this.state.ouid}/>
                  </div>
                </div>

                <div class="column ">
                  <div className="box m-5">
                    <h5 className="title m-b-0 m-l-10 is-6 fcprimary-dark text-caps text-center">Caesarean section rate for the period:  {this.state.period}</h5>
                    <br/>
                    <IndicatorLineGraph id={32146} pe={this.state.period} ouid={this.state.ouid}/>
                  </div>
                </div>
