...
import {fetchMultiVariateIndicPredictionData} from '../../components/utils/Helpers';
...
export default class extends React.Component {
  ...
  fetchData(){
    ...
    (async () => {
      let indicatorData=await fetchMultiVariateIndicPredictionData(this.state.id,this.state.ouid,this.state.corrIndicators,this.state.periodSpan);
      this.setState({
